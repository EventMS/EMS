...
namespace EMS.GraphQL.API
{
    ...
    public class DelegateExtensionType : HelperDelegateExtension
    {
        ...
        public DelegateExtensionType(string typeToExtend, string newFieldName, string queryName, params string[] argumentsAsString)
        {
            _typeToExtend = typeToExtend;
            NewFieldName = newFieldName;
            _queryName = queryName;
            _arguments = argumentsAsString;
        }
        ...
        public override bool Applyable(ObjectTypeDefinitionNode objectTypeDefinition, FieldDefinitionNode queryDefinition)
        {
            if (objectTypeDefinition.Name.Value != _typeToExtend)
            {
                return false;
            }
