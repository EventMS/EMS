...
namespace EMS.ClubMember_Services.API
{
    ...
    public class ProgramHelper : BaseProgramHelper<Startup>
    {
        ...
        {
            host.MigrateDbContext<ClubMemberContext>((context, services) =>
                {
                    var env = services.GetService<IWebHostEnvironment>();
                    var settings = services.GetService<IOptions<BaseSettings>>();
                    var logger = services.GetService<ILogger<ClubMemberContextSeed>>();

                    new ClubMemberContextSeed()
    ...
    public class Program
    {
        ...
        public static string AppName = "ClubMember.API";
