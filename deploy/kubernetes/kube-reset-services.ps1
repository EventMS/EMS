...
Get-ChildItem -Directory -Filter *Service | ForEach-Object {kubectl delete -f .\$_\local.;}
# kubectl apply -f .\Ingress\.; # No need to always delete the ingress as it takes forever to get it up again


#Deploy all resources
kubectl apply -f .\Namespaces\.;
Get-ChildItem -Directory -Filter *Service | ForEach-Object {kubectl apply -k .\$_\local\.;}
